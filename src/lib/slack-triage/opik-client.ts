...
/**
 * Opik client singleton for Slack triage observability.
 * 
 * Configure via environment variables:
 * - OPIK_API_KEY: Your Opik API key
 * - OPIK_URL_OVERRIDE: Opik API URL (default: https://www.comet.com/opik/api)
 * - OPIK_PROJECT_NAME: Project name (default: maxwell-slack-triage)
...
export function getOpik(): Opik {
  if (!opikClient) {
    opikClient = new Opik({
      projectName: process.env.OPIK_PROJECT_NAME || 'maxwell-slack-triage',
