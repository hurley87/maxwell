...
function CalendarDayButton({
  ...
  return (
    ...
    >
      {props.children}
      {modifiers.hasNote && (
        <span className="absolute bottom-1 left-1/2 -translate-x-1/2 h-1 w-1 rounded-full bg-primary data-[selected-single=true]:bg-primary-foreground data-[range-start=true]:bg-primary-foreground data-[range-end=true]:bg-primary-foreground" />
      )}
    </Button>
  )
}
